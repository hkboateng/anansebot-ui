...
function setUserResponse(message) {
	var UserResponse = '<img class="userAvatar" src=' + "../../assets/images/userAvatar.jpg" + '><p class="userMsg">' + message + ' </p><div class="clearfix"></div>';
...
function setBotResponse(response) {
	...
	setTimeout(function () {
		...
		if (response.length < 1) {
			...
			var BotResponse = '<img class="botAvatar" src="../../assets/images/botAvatar.png"/><p class="botMsg">' + fallbackMsg + '</p><div class="clearfix"></div>';
			...
			for (i = 0; i < response.length; i++) {
				...
				if (response[i].hasOwnProperty("text")) {
					var BotResponse = '<img class="botAvatar" src="../../assets/images/botAvatar.png"/><p class="botMsg">' + response[i].text + '</p><div class="clearfix"></div>';
					$(BotResponse).appendTo(".chats").hide().fadeIn(1000);
				}
...
function showBotTyping() {
	...
	var botTyping = '<img class="botAvatar" id="botAvatar" src="../../assets/images/botAvatar.png"/><div class="botTyping">' + '<div class="bounce1"></div>' + '<div class="bounce2"></div>' + '<div class="bounce3"></div>' + '</div>'
